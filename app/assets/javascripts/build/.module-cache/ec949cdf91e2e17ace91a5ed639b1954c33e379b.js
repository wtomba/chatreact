      ...
      return (
        React.createElement("div", {key: this.props.id, className: "message"}, 
          React.createElement("blockquote", {className: "active"}, 
            React.createElement("a", {href: "#", className: "edit-message right", "data-options": "align:left;", "data-dropdown": "dropmessage"+this.props.id, "aria-controls": "dropmessage"+this.props.id, "aria-expanded": "false"}, React.createElement("i", {className: "fi-widget"})), 
            React.createElement("ul", {id: "dropmessage"+this.props.id, "data-dropdown-content": true, className: "f-dropdown edit-message-dropdown", "aria-hidden": "true", tabIndex: "-1"}, 
