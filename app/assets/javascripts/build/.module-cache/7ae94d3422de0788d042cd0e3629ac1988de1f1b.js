window.ConversationNameModal = React.createClass({displayName: "ConversationNameModal",
    ...
    statics: {
        ...
        open: function(props) {
		    ...
		    TweenMax.from(modal, 1, { left: wrap.offset().left + padding, width: wrap.outerWidth() - padding*2, top: -$(".modal").height(), height: 0, ease: Elastic.easeOut, onComplete: function () {
