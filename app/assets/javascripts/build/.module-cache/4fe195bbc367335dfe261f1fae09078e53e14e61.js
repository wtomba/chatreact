var LeftSideBar = React.createClass({displayName: "LeftSideBar",
  ...
  toggleNotifications: function (e) {
    ...
    if (JSON.parse(localStorage.getItem('user')).notifications) {
      var user = JSON.parse(localStorage.getItem('user'));
        ...
        React.createElement("ul", {className: "off-canvas-list"}, 
          ...
          React.createElement("li", null, 
            ...
            React.createElement("ul", {id: "drop"+this.state.user.id, "data-dropdown-content": true, className: "f-dropdown", "aria-hidden": "true", tabIndex: "-1"}, 
              React.createElement("li", null, React.createElement("a", {href: "#", onClick: this.toggleNotifications}, JSON.parse(localStorage.getItem('user')).notifications ? "Stäng av ljudnotifikation" : "Sätt på ljudnotifikation")), 
