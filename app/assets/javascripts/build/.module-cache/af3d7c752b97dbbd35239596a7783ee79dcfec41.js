...
var ChatBox = React.createClass({displayName: "ChatBox",
  ...
  loadMessagesFromServer: function (e, id) {
    ...
    if (id && id != "leave") {
      url += "/"+ id;
    } else if (this.props.id && id != "leave") {
      url += "/"+ this.props.id;
    }
        ...
        if (data.conversation) {
          this.setState({messages: data.messages,
                          conversation: data.conversation}, function () {
                            ...
                            mainComponent.setProps( { id: data.conversation.id } );
  ...
  handleMessageSubmit: function (message, id) {
    var url = this.props.url+"/" +this.props.id;
