      ...
      React.createElement("div", null, 
        React.createElement("ul", {className: "off-canvas-list"}, 
          ...
          React.createElement("li", null, 
            React.createElement("a", {href: "#", className: "profile-name", "data-options": "align:bottom;", "data-dropdown": "dropuser"+this.state.user.id, "aria-controls": "dropuser"+this.state.user.id, "aria-expanded": "false"}, this.state.user.username), 
            React.createElement("ul", {id: "dropuser"+this.state.user.id, "data-dropdown-content": true, className: "f-dropdown", "aria-hidden": "true", tabIndex: "-1"}, 
              React.createElement("li", null, React.createElement("a", {href: "#", className: "text-center", onClick: this.toggleNotifications}, React.createElement(NotificationIcon, {user: this.state.user}))), 
              React.createElement("li", null, React.createElement("a", {href: "#", className: "text-center", onClick: this.logOut}, React.createElement("i", {className: "fi-lock left"}), "Logga ut"))
            )
          ), 
  ...
  render: function () {
    ...
    return (
      React.createElement("span", null, 
        React.createElement("i", {className: iconClass + " left"}), 
        text
      )
    );
  }
      ...
      if (attendee_ids.indexOf(user.id) > -1) {
        return (
          React.createElement("li", {key: user.id}, 
            React.createElement("a", {href: "#", "data-dropdown": "dropconnection"+user.id, "aria-controls": "dropconnection"+user.id, "aria-expanded": "false"}, user.username), 
            React.createElement("ul", {id: "dropconnection"+user.id, "data-dropdown-content": true, className: "f-dropdown", "aria-hidden": "true", tabIndex: "-1"}, 
        ...
        return (
          React.createElement("li", {key: user.id}, 
            React.createElement("a", {className: "draggable", id: user.id, href: "#", "data-dropdown": "dropconnection"+user.id, "aria-controls": "dropconnection"+user.id, "aria-expanded": "false"}, 
