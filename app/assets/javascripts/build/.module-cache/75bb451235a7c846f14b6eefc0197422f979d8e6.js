    ...
    closeHandler: function () {
      var button = $(".conversation."+this.props.id),
        ...
        if (!this.state.animation_running) {
          ...
          TweenMax.set(modal, { width: wrap.outerWidth() - 40, top: -modal.height(), height: 0 });
          TweenMax.from(modal, 1, { width: wrap.outerWidth() - 40, height: modalHeight, top: "15%", ease: Sine.easeOut, onComplete: function () {
