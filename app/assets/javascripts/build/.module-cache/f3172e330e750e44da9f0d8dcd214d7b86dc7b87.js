      ...
      React.createElement("div", null, 
        React.createElement("ul", {className: "off-canvas-list"}, 
          ...
          React.createElement("li", null, 
            React.createElement("a", {href: "#", className: "profile-name", "data-dropdown": "drop"+this.state.user.id, "aria-controls": "drop"+this.state.user.id, "aria-expanded": "false"}, this.state.user.username), 
